...
class VnetBuilder(object):
    ...
    def build_model(self, input_shape, padding=(44, 44, 22), downsize_filters_factor=1, pool_size=(2, 2, 2),
        ...
        conv1a = Conv3D(int(32/downsize_filters_factor), (3, 3, 3), activation='relu', padding='valid',
                        kernel_regularizer=regularizers.l2(0), kernel_initializer='glorot_uniform',
                        name='conv1a')(conv1p)
        conv1b = Conv3D(int(64/downsize_filters_factor), (3, 3, 1), activation='relu', padding='valid',
                        kernel_regularizer=regularizers.l2(0), kernel_initializer='glorot_uniform',
                        name='conv1b')(conv1a)
        pool1 = MaxPooling3D(pool_size=pool_size, name='pool1')(conv1b)
        conv2a = Conv3D(int(64/downsize_filters_factor), (3, 3, 3), activation='relu', padding='valid',
                        kernel_regularizer=regularizers.l2(0), kernel_initializer='glorot_uniform',
                        name='conv2a')(pool1)
        conv2b = Conv3D(int(128/downsize_filters_factor), (3, 3, 1), activation='relu', padding='valid',
                        kernel_regularizer=regularizers.l2(0), kernel_initializer='glorot_uniform',
                        name='conv2b')(conv2a)
        pool2 = MaxPooling3D(pool_size=pool_size, name='pool2')(conv2b)
        conv3a = Conv3D(int(128/downsize_filters_factor), (3, 3, 3), activation='relu', padding='valid',
                        kernel_regularizer=regularizers.l2(0), kernel_initializer='glorot_uniform',
                        name='conv3a')(pool2)
        conv3b = Conv3D(int(256/downsize_filters_factor), (3, 3, 1), activation='relu', padding='valid',
                        kernel_regularizer=regularizers.l2(0), kernel_initializer='glorot_uniform',
                        name='conv3b')(conv3a)
        pool3 = MaxPooling3D(pool_size=pool_size, name='pool3')(conv3b)
        conv4a = Conv3D(int(256/downsize_filters_factor), (3, 3, 3), activation='relu', padding='valid',
                        kernel_regularizer=regularizers.l2(0), kernel_initializer='glorot_uniform',
                        name='conv4a')(pool3)
        conv4b = Conv3D(int(512/downsize_filters_factor), (3, 3, 1), activation='relu', padding='valid',
                        kernel_regularizer=regularizers.l2(0), kernel_initializer='glorot_uniform',
                        name='conv4b')(conv4a)
        ...
        conv5a = Conv3D(int(256/downsize_filters_factor), (3, 3, 3), activation='relu', padding='valid',
                        kernel_regularizer=regularizers.l2(0), kernel_initializer='glorot_uniform',
                        name='conv5a')(up5b)
        conv5b = Conv3D(int(256/downsize_filters_factor), (3, 3, 1), activation='relu', padding='valid',
                        kernel_regularizer=regularizers.l2(0), kernel_initializer='glorot_uniform',
                        name='conv5b')(conv5a)
        up6a = UpSampling3D(size=pool_size, name='up6a')(conv5b)
        up6b = self.bridge(conv2b, up6a)
        conv6a = Conv3D(int(128/downsize_filters_factor), (3, 3, 3), activation='relu', padding='valid',
                        kernel_regularizer=regularizers.l2(0), kernel_initializer='glorot_uniform',
                        name='conv6a')(up6b)
        conv6b = Conv3D(int(128/downsize_filters_factor), (3, 3, 1), activation='relu', padding='valid',
                        kernel_regularizer=regularizers.l2(0), kernel_initializer='glorot_uniform',
                        name='conv6b')(conv6a)
        up7a = UpSampling3D(size=pool_size, name='up7a')(conv6b)
        up7b = self.bridge(conv1b, up7a)
        conv7a = Conv3D(int(64/downsize_filters_factor), (3, 3, 3), activation='relu', padding='valid',
                        kernel_regularizer=regularizers.l2(0), kernel_initializer='glorot_uniform',
                        name='conv7a')(up7b)
        conv7b = Conv3D(int(64/downsize_filters_factor), (3, 3, 1), activation='relu', padding='valid',
                        kernel_regularizer=regularizers.l2(0), kernel_initializer='glorot_uniform',
                        name='conv7b')(conv7a)
        ...
        # Add optimizer and loss function
            model_with_encoder.compile(optimizer=Adam(lr=initial_learning_rate),
                      loss={'seg': self.weighted_categorical_crossentropy,
                            'seg_encoded': 'binary_crossentropy'},
                      loss_weights={'seg': 1.,
                                    'seg_encoded': 0.2},
                      metrics=metrics)
