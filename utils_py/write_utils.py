...
def create_output_folders(config):
    if not os.path.exists(config['data']['figures_dir']):
        os.makedirs(config['data']['figures_dir'])
    if not os.path.exists(config['data']['hdf5data_dir']):
        os.makedirs(config['data']['hdf5data_dir'])
    if not os.path.exists(config['data']['newmodel_dir']):
        os.makedirs(config['data']['newmodel_dir'])
    if not os.path.exists(config['data']['logging_dir']):
        os.makedirs(config['data']['logging_dir'])
    if not os.path.exists(config['data']['pickle_dir']):
        os.makedirs(config['data']['pickle_dir'])
    if not os.path.exists(config['data']['mhd_dir']):
        os.makedirs(config['data']['mhd_dir'])
    if not os.path.exists(config['data']['encoder_dir']):
        os.makedirs(config['data']['encoder_dir'])
...
def write_slices_to_sitk(array, filename):
    shape = array.shape
    dataDir = os.path.abspath("./figures")
    if len(shape) > 3:
